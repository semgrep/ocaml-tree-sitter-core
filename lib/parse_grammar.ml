...
let rec parse_body json =
  match json with
  | ((J.Object
        (("type", ((J.String ("REPEAT"))))::("content", json)::[]))
    ) -> ((REPEAT ((parse_body json))))
  | ((J.Object
        (("type", ((J.String ("CHOICE"))))::("members",
                                             ((J.Array
                                                 (xs))))::[]))
    ) -> ((CHOICE ((List.map parse_body xs)))
         )
  | ((J.Object
        (("type", ((J.String ("SEQ"))))::("members",
                                          ((J.Array
                                              (xs))))::[]))
    ) -> ((SEQ ((List.map parse_body xs)))
         )
  | ((J.Object
        (("type", ((J.String ("SYMBOL"))))::("name",
                                             ((J.String
                                                 (name))))::[]))
    ) -> ((SYMBOL (name)))
  | ((J.Object
        (("type", ((J.String ("STRING"))))::("value",
                                             ((J.String
                                                 (name))))::[]))
    ) -> ((STRING (name)))
  | ((J.Object
        (("type", ((J.String ("PATTERN"))))::("value",
                                              ((J.String
                                                  (name))
                                              ))::[]))
    ) -> ((PATTERN (name)))
  | ((J.Object
        (("type", ((J.String
         ...
         ("value", _)::("content", json)::[])))
    -> parse_body json
  | ((J.Object
        (("type", ((J.String ("FIELD"))))::("name",
                                            ((J.String
                                                (_name))))::
         ("content", json)::[])))
    -> parse_body json
