...
let rec parse_assignment_statement = (json: J.json_type): assignment_statement => {
   ...
   | J.Array([
      ...
      J.Object([("type", J.String(";")),
               ("children", _)])
      ]) => (parse_variable(local_var1),"=",parse_expression(local_var2),";")
         | _ => error("Bad", json)
      }
      }
...
and parse_expression = (json: J.json_type): expression => {
   ...
   | J.Array([
      ...
      J.Object([("type", J.String("expression")),
               ("children", local_var2)])
      ]) => Intermediate_type5((parse_expression(local_var1),"+",parse_expression(local_var2)))
   ...
   | J.Array([
      ...
      J.Object([("type", J.String("expression")),
               ("children", local_var2)])
      ]) => Intermediate_type6((parse_expression(local_var1),"-",parse_expression(local_var2)))
   ...
   | J.Array([
      ...
      J.Object([("type", J.String("expression")),
               ("children", local_var2)])
      ]) => Intermediate_type7((parse_expression(local_var1),"*",parse_expression(local_var2)))
   ...
   | J.Array([
      ...
      J.Object([("type", J.String("expression")),
               ("children", local_var2)])
      ]) => Intermediate_type8((parse_expression(local_var1),"/",parse_expression(local_var2)))
   ...
   | J.Array([
      ...
      J.Object([("type", J.String("expression")),
               ("children", local_var2)])
      ]) => Intermediate_type9((parse_expression(local_var1),"^",parse_expression(local_var2)))
