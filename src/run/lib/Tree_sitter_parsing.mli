...
(* Parse a source file with the provide parser, which is normally a C parser
   generated by tree-sitter. The optional timeout_micros argument sets a
   timeout in microseconds for parsing. *)
...
(* Parse a string. The optional src_file argument is for error messages.
   The optional timeout_micros argument sets a timeout in microseconds for parsing. *)
